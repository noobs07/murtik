            ...
            <ul class="nav navbar-collapse collapse bootstrap-admin-navbar-side">
                ...
                <li>
                    ...
                    <ul class="nav navbar-collapse bootstrap-admin-navbar-side">
                        <li <?= (!empty($pages) && $pages=='all-trx'? 'class="active"':'')?>><a href="<?= base_url('all-trx')?>"><i class="glyphicon glyphicon-chevron-right"></i> Pesawat <span class="label label-primary " id="jumlah"></span></a></li>
                        <li <?= (!empty($pages) && $pages=='all-trx-kai'? 'class="active"':'')?>><a href="<?= base_url('all-trx-kai')?>"><i class="glyphicon glyphicon-chevron-right"></i> Kereta <span class="label label-primary " id="jumlah_kai"></span></a></li>
                        <li <?= (!empty($pages) && $pages=='all-trx-pelni'? 'class="active"':'')?>><a href="<?= base_url('all-trx-pelni')?>"><i class="glyphicon glyphicon-chevron-right"></i> PELNI <span class="label label-primary " id="jumlah_pelni"></span></a></li>
                        <li <?= (!empty($pages) && $pages=='all-trx-hotel'? 'class="active"':'')?>><a href="<?= base_url('all-trx-hotel')?>"><i class="glyphicon glyphicon-chevron-right"></i> Hotel <span class="label label-primary " id="jumlah_hotel"></span></a></li>
                        <li <?= (!empty($pages) && $pages=='cancelled-trx'? 'class="active"':'')?>><a href="<?= base_url('cancelled-trx')?>"><i class="glyphicon glyphicon-chevron-right"></i> Tiket Batal</a></li>
                    </ul>
                ...
                <li>
                    <ul class="nav navbar-collapse bootstrap-admin-navbar-side">
                        <li <?= (!empty($pages) && $pages=='confirmasi_bayar'? 'class="active"':'')?>>
                            <a href="<?= base_url('konfirmasi-bayar')?>"><i class="glyphicon glyphicon-chevron-right"></i>Konfirmasi Pembayaran<span class="label label-primary " id="jumlah_konfirmasi"></span></a>
                        </li>
                </ul>
                </li>                 
            </ul>
